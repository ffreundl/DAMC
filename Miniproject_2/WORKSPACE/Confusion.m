...
%training error
    ...
    figure;
    % set1 is training and set2 is test
    subplot(2,3,1)
    bar(1,training_error_linear,'b');
    hold on
    bar(2,testing_error_linear, 'r');
    set(gca, 'xtick',[]);
    subplot(2,3,2)
    bar(1,training_error_diaglinear,'b');
    hold on
    bar(2,testing_error_diaglinear, 'r');
    set(gca, 'xtick',[]);
    subplot(2,3,3)
    bar(1,training_error_diagquadratic,'b');
    hold on
    bar(2,testing_error_diagquadratic, 'r');
    set(gca, 'xtick',[]);
    % set2 is training and set1 is test
    subplot(2,3,4)
    bar(1,training_error_linear_2,'b');
    hold on
    bar(2,testing_error_linear_2, 'r');
    set(gca, 'xtick',[]);
    subplot(2,3,5)
    bar(1,training_error_diaglinear_2,'b');
    hold on
    bar(2,testing_error_diaglinear_2, 'r');
    set(gca, 'xtick',[]);
    subplot(2,3,6)
    bar(1,training_error_diagquadratic_2,'b');
    hold on
    bar(2,testing_error_diagquadratic_2, 'r');
    set(gca, 'xtick',[]);