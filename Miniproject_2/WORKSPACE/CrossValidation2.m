...
erreur_classi_leave_one_diagquadri=[];
...
classiError_quadri_repartition=[];
...
classiError_leave_one_diagquadri_new=[];
...
subplot(2,4,8);
bar(1,erreur_classi_leave_one_quadra,'b');
hold on;
bar(2,erreur_classi_leave_one_quadra_new,'r');
set(gca,'xtick',[]);
